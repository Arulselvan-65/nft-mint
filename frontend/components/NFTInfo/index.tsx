...
function NFTInfo() {
    ...
    useEffect(() => {
        const client = createPublicClient({
            ...
            transport: process.env.NEXT_PUBLIC_ENVIRONMENT == "dev" ? http(`${process.env.NEXT_PUBLIC_SEPOLIA_RPC_URL}`) : http("http://127.0.0.1:8545")
        });
        ...
        <>
            ...
            <div className="text-[#c5c5c5] border-solid border-[#3a3a3a] border-[1px] 
                ...
                <div className="flex justify-center p-8 flex-col items-center pb-0">
                    ...
                    <p className="font-bold text-2xl mt-4">{`DevBadge ${(hasMinted ? `#${mintedTokenId}` : "")}`}</p>
                    {
                        hasMinted ?
                   ...
                   text-white font-medium"
                        ...
                        <>
                            ...
                            <div className="flex justify-center">
                                <button className="w-72 h-12 bg-[#3b99fd] rounded-lg m-4 font-bold text-lg text-white"
